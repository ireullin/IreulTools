...
public class MutableDatetimeTest {
    private static final Logger LOG = LoggerFactory.getLogger(MutableDatetimeTest.class);
    ...
    public void testAddorSub() {
        ...
        try {
            IDatetime pre = MutableDatetime.of(2016, 5, 4, 23, 30, 59, 0);
        ...
        // 閏年
        try {
            IDatetime pre = MutableDatetime.of(2016, 2, 27, 23, 30, 59, 0);
        ...
        // 沒閏年
        try {
            IDatetime pre = MutableDatetime.of(2015, 2, 27, 23, 30, 59, 0);
            IDatetime cur = pre.addOrSubDay(2);
            LOG.info(cur.toString());
    ...
    public void testZeroDay() {
        try {
            IDatetime dt1 = MutableDatetime.zeroDay();
            LOG.info(dt1.getTimeZone().toString());
            LOG.info(dt1.toString());

            IDatetime dt2 = MutableDatetime.readFrom("1970-01-01 08:00:00.000", "yyyy-MM-dd HH:mm:ss.SSS");
            dt2.toUTC();
    ...
    public void testReset() throws Exception{
        ...
        IDatetime dt1 = MutableDatetime.readFrom(sample, "yyyy-MM-dd HH:mm:ss");
        LOG.info(dt1.toString("yyyy-MM-dd HH:mm:ss a"));

        IDatetime dt2 = MutableDatetime.now();
    ...
    public void testTimeZone() {
        try {
            IDatetime dt1 = MutableDatetime.now();
            ...
            IDatetime dt3 = MutableDatetime.readFrom("2016-10-25 16:07:21 TST", "yyyy-MM-dd HH:mm:ss zzz");
            LOG.info("{} {}", dt3.toString("yyyy-MM-dd HH:mm:ss zzz"), dt3.getTimeZone());

            //!!!!!!!!!! it will get CEST. I don't know why ????????
            IDatetime dt4 = MutableDatetime.readFrom("2016-10-25 16:07:21 UTC", "yyyy-MM-dd HH:mm:ss zzz");
            LOG.info("{} {}", dt4.toString("yyyy-MM-dd HH:mm:ss zzz"), dt4.getTimeZone());

            IDatetime dt5 = MutableDatetime.readFrom("2016-10-25 16:07:21", "yyyy-MM-dd HH:mm:ss");
    ...
    public void testMain() {
        ...
        IDatetime dt1 = MutableDatetime.now().year(2012).month(2).day(15).hour(6).min(10).sec(5).millis(200);
        IDatetime dt2 = MutableDatetime.of(2012,2,15,6,10,5,200);
        LOG.info(dt1.toString());
        LOG.info(dt2.toString());
        assertEquals(dt1.equals(dt2),true);

        IDatetime dt3 = MutableDatetime.of(2015,8,4,9,10,15,000);
        ...
        dt3.toEndOfDay();
        LOG.info(dt3.toString());
        assertEquals("2015-08-04 23:59:59.999", dt3.toString());

        LOG.info("{} stamp:{}", dt3.toString(), dt3.stamp());
        assertEquals(1438703999999l, dt3.stamp());

        LOG.info("==============================");

        IDatetime dt4 = MutableDatetime.of(dt3.stamp());
        LOG.info(dt4.toString());
        assertEquals(dt3.stamp(), dt4.stamp());
        LOG.info("==============================");

        try {
            IDatetime dt5 = MutableDatetime.readFrom("20140825130972321", "yyyyMMddHHmmssSSS");
        ...
        try{
            IDatetime dt6 = MutableDatetime.readFrom("2010-03-01 10:00:00","yyyy-MM-dd HH:mm:ss") .tap(dt -> LOG.info("Started at"+dt.toString()) )
        ...
        IDatetime dtA = MutableDatetime.now();
